...
export function MarqueeSkeleton() {
  return (
    <section className="border-line relative overflow-hidden border-b">
      <div className="px-pad desktop:grid-cols-[minmax(0,1.15fr)_minmax(0,.85fr)] desktop:min-h-[clamp(520px,76vh,760px)] desktop:gap-[clamp(24px,4vw,56px)] mx-auto grid w-full max-w-[1440px] grid-cols-1 content-center gap-0">
